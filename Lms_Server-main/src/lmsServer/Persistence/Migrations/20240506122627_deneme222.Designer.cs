...
namespace Persistence.Migrations
{
    ...
    [Migration("20240506122627_deneme222")]
    partial class deneme222
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("84211ca1-592c-44ca-a5bf-a86146a817e3"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 218, 148, 1, 18, 111, 195, 238, 133, 141, 7, 3, 94, 11, 217, 154, 46, 153, 216, 55, 213, 59, 237, 53, 69, 93, 15, 142, 115, 131, 211, 69, 59, 232, 98, 61, 17, 180, 84, 168, 60, 36, 60, 45, 169, 227, 50, 192, 63, 141, 162, 76, 151, 215, 155, 197, 145, 1, 111, 99, 114, 133, 243, 232, 199 },
                            PasswordSalt = new byte[] { 208, 220, 65, 180, 226, 21, 219, 185, 150, 56, 9, 37, 243, 108, 105, 210, 224, 33, 172, 98, 85, 97, 155, 85, 89, 209, 247, 73, 146, 210, 32, 34, 9, 100, 82, 40, 75, 109, 141, 59, 183, 122, 92, 217, 124, 91, 218, 2, 244, 112, 47, 205, 87, 162, 193, 157, 153, 185, 145, 107, 110, 19, 239, 32, 220, 27, 56, 10, 105, 97, 145, 121, 148, 132, 81, 28, 20, 175, 198, 89, 143, 226, 212, 252, 175, 41, 172, 199, 246, 105, 254, 78, 165, 180, 59, 214, 206, 55, 9, 95, 93, 165, 90, 23, 214, 17, 145, 96, 60, 249, 15, 46, 58, 32, 133, 147, 44, 251, 194, 28, 88, 138, 129, 37, 223, 204, 6, 151 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8fa0a4f2-5958-4a18-8eb7-47e9c59005d3"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("84211ca1-592c-44ca-a5bf-a86146a817e3")
                        });
                });
