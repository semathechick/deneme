...
namespace Persistence.Migrations
{
    ...
    [Migration("20240501103634_bookedited")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a0bd54e1-80d0-455e-96b7-630a21db4981"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 22, 33, 192, 17, 171, 224, 112, 158, 64, 108, 90, 154, 170, 91, 13, 150, 114, 35, 154, 204, 206, 149, 226, 181, 24, 240, 236, 170, 32, 28, 220, 45, 252, 236, 232, 84, 232, 71, 111, 249, 71, 220, 188, 93, 214, 254, 216, 50, 229, 15, 252, 51, 201, 126, 31, 216, 249, 156, 6, 232, 222, 233, 151, 172 },
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4e08f53c-8a4d-4dcb-a500-14dbc84c0f09"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("a0bd54e1-80d0-455e-96b7-630a21db4981")
                        });
                });
