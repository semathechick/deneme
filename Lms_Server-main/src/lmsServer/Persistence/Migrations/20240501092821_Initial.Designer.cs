...
namespace Persistence.Migrations
{
    ...
    [Migration("20240501092821_Initial")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d0c94fc5-84ce-4b57-b0cf-ea6a4269e9c7"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 176, 82, 137, 88, 97, 137, 134, 229, 178, 62, 138, 100, 48, 52, 86, 233, 136, 81, 77, 241, 63, 26, 232, 210, 100, 161, 248, 146, 117, 231, 61, 93, 153, 203, 219, 112, 18, 114, 212, 123, 180, 73, 174, 185, 190, 93, 7, 118, 26, 75, 221, 59, 57, 103, 44, 176, 60, 226, 229, 226, 91, 218, 32, 93 },
                            PasswordSalt = new byte[] { 158, 187, 150, 83, 245, 161, 242, 159, 77, 178, 47, 118, 28, 239, 218, 100, 164, 160, 107, 214, 53, 231, 122, 8, 6, 79, 117, 159, 216, 209, 75, 120, 63, 127, 162, 24, 151, 80, 115, 250, 75, 70, 125, 148, 149, 176, 127, 17, 188, 0, 190, 45, 83, 43, 15, 195, 115, 210, 41, 164, 92, 2, 115, 147, 233, 128, 195, 27, 1, 203, 87, 17, 122, 72, 247, 150, 204, 214, 107, 0, 128, 133, 250, 5, 71, 163, 101, 46, 137, 194, 45, 240, 202, 127, 209, 34, 103, 110, 127, 12, 99, 79, 239, 85, 100, 202, 116, 173, 2, 30, 39, 14, 151, 189, 39, 243, 173, 221, 50, 185, 28, 55, 52, 196, 35, 155, 176, 72 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("205152bd-dbf7-49ee-b6f2-cf22f02e1e19"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("d0c94fc5-84ce-4b57-b0cf-ea6a4269e9c7")
                        });
                });
